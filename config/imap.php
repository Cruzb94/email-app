    ...
    */  
    'accounts' => [
        ...
        'default' => [// account identifier
            ...
            'username' => env('IMAP_USERNAME', 'soporte@aritd.com'),
            'password' => env('IMAP_PASSWORD', '87ujC&+62#Db'),
            'authentication' => env('IMAP_AUTHENTICATION', true),
            'proxy' => [
                'socket' => null,
     ...
     /*    'another' => [ // account identifier
            ...
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'soporte@aritd.com',
            'password' => '87ujC&+62#Db',
            'authentication' => null,
        ]
